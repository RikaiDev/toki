...
use crate::models::{
    Activity, ActivitySpan, Category, ClassificationRule, ClaudeSession, IntegrationConfig,
    IssueCandidate, PatternType, Project, Session, Settings, SyncedIssue, WorkItem,
};
...
impl Database {
    ...
    fn row_to_claude_session(row: &rusqlite::Row) -> rusqlite::Result<ClaudeSession> {
        Ok(ClaudeSession {
            id: uuid::Uuid::parse_str(&row.get::<_, String>(0)?).unwrap(),
